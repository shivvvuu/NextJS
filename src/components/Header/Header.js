...
const Header = () =>  (
 <Container>
  <Div1>
    <Link href="/">
      <p style={{ display:"flex" ,alignItem:"center", color:"white" }}>
        <DiCssdeck size="3rem"  /><Link href="#">
        <NavLink>Shivam Jhod</NavLink>
      </Link>
      </p>
    </Link>
  </Div1>
  <Div2>
    <li>
      <Link href="https://www.shivamjhod21.tech/#projects">
        <NavLink>Projects</NavLink>
      </Link>
    </li>
    <li>
      <Link href="https://www.shivamjhod21.tech/#tech">
        <NavLink>Technologies</NavLink>
      </Link>
    </li>
    <li>
      <Link href="https://www.shivamjhod21.tech/#about">
